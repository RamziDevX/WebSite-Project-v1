  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8 text-center">
        <h1 className="text-3xl md:text-4xl font-bold text-charcoal-dark mb-2">Welcome to Dzair Styles</h1>
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          Discover the beauty of Algerian fashion with our collection of traditional and modern clothing.
        </p>
      </div>
